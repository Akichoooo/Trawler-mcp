...
> **📂 源码锚点**：
> - [`trawler/server.py`](trawler/server.py) (FastMCP 服务注册与 API 暴露)
> - [`trawler/crawl_url.py`](trawler/crawl_url.py) (单页调度中心)
> - [`trawler/crawl_site.py`](trawler/crawl_site.py) (多页 Frontier 调度)
> 
> **🎯 核心职责**：
...
> **📂 源码锚点**：
> - [`trawler/fetcher/curlcffi_rung.py`](trawler/fetcher/curlcffi_rung.py) (Rung 0: 极速 TLS 伪造)
> - [`trawler/fetcher/patchright_rung.py`](trawler/fetcher/patchright_rung.py) (Rung 1: 拟人反检测浏览器)
> - [`trawler/fetcher/hitl_rung.py`](trawler/fetcher/hitl_rung.py) (Rung 3: 真人交互突防)
> - [`trawler/account_vault.py`](trawler/account_vault.py) (凭证管理中心)
> 
> **🎯 核心职责**：
...
> **📂 源码锚点**：
> - [`trawler/parser/extract.py`](trawler/parser/extract.py) (清洗管道入口)
> - [`trawler/parser/oom_safe.py`](trawler/parser/oom_safe.py) (内存溢出熔断)
> - [`trawler/parser/selectors.py`](trawler/parser/selectors.py) (局部 CSS 抽取)
> 
> **🎯 核心职责**：
...
> **📂 源码锚点**：
> - [`trawler/ssrf.py`](trawler/ssrf.py) (防 SSRF 模块)
> - [`trawler/parser/safety.py`](trawler/parser/safety.py) (合规与脱敏引擎)
> - [`data/sensitive_words.txt`](data/sensitive_words.txt) (热更新合规词库)
> 
> **🎯 核心职责**：
...
> **📂 源码锚点**：
> - [`trawler/db.py`](trawler/db.py) (SQLite WAL 模式配置)
> - [`trawler/db_writer.py`](trawler/db_writer.py) (异步内存队列写入器)
> - [`trawler/audit.py`](trawler/audit.py) (审计记录)
> 
> **🎯 核心职责**：
